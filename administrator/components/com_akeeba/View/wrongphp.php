...
<div style="margin: 1em">
	...
	<p style="font-size: 180%; margin: 2em 1em;">
		Akeeba Backup requires PHP 5.4 or any later version to work.
	</p>
	<p>
		We <b>strongly</b> urge you to update to PHP 5.6 or later. If unsure how to do this, please ask your host.
	</p>
	<p>
